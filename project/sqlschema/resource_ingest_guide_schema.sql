...
--     * Slot: id
--     * Slot: infores_id Description: The infores identifier of the source from which content is being ingested, e.g. "infores:ctd".
--     * Slot: name Description: A human readable name for the source
--     * Slot: description Description: A brief description of the source, including its purpose, scope, and any relevant background information.
...
--     * Slot: source_status Description: A term indicating the development status of the data provided by resource.
--     * Slot: terms_of_use_info_id Description: Information about conditions for use of the ingested source. May include the name of a community license (e.g. `CC-BY 4.0`), a link to a "terms of use" or license information web page (e.g. `https://ctdbase.org/about/legal.jsp`), and/or a free-text summary of key terms of use.
...
-- # Class: SourceInformation_additional_notes
--     * Slot: SourceInformation_id Description: Autocreated FK slot
...
-- # Class: IngestInformation_additional_notes
--     * Slot: IngestInformation_id Description: Autocreated FK slot
...
-- # Class: TargetInformation_additional_notes
--     * Slot: TargetInformation_id Description: Autocreated FK slot
...
-- # Class: EdgeType_additional_notes
--     * Slot: EdgeType_id Description: Autocreated FK slot
...
-- # Class: NodeType_additional_notes
--     * Slot: NodeType_id Description: Autocreated FK slot
...
);CREATE INDEX "ix_IngestInformation_filtered_content_filtered_content_id" ON "IngestInformation_filtered_content" (filtered_content_id);CREATE INDEX "ix_IngestInformation_filtered_content_IngestInformation_id" ON "IngestInformation_filtered_content" ("IngestInformation_id");
...
CREATE TABLE "IngestInformation_additional_notes" (
	...
	PRIMARY KEY ("IngestInformation_id", additional_notes),
	FOREIGN KEY("IngestInformation_id") REFERENCES "IngestInformation" (id)
);CREATE INDEX "ix_IngestInformation_additional_notes_additional_notes" ON "IngestInformation_additional_notes" (additional_notes);CREATE INDEX "ix_IngestInformation_additional_notes_IngestInformation_id" ON "IngestInformation_additional_notes" ("IngestInformation_id");
...
);CREATE INDEX "ix_TargetInformation_edge_type_info_edge_type_info_id" ON "TargetInformation_edge_type_info" (edge_type_info_id);CREATE INDEX "ix_TargetInformation_edge_type_info_TargetInformation_id" ON "TargetInformation_edge_type_info" ("TargetInformation_id");
...
CREATE TABLE "TargetInformation_additional_notes" (
	"TargetInformation_id" INTEGER,
	additional_notes TEXT,
...
CREATE TABLE "EdgeType_edge_properties" (
	...
	FOREIGN KEY("EdgeType_id") REFERENCES "EdgeType" (id)
);CREATE INDEX "ix_EdgeType_edge_properties_EdgeType_id" ON "EdgeType_edge_properties" ("EdgeType_id");CREATE INDEX "ix_EdgeType_edge_properties_edge_properties" ON "EdgeType_edge_properties" (edge_properties);
...
);CREATE INDEX "ix_NodeType_source_identifier_types_NodeType_id" ON "NodeType_source_identifier_types" ("NodeType_id");CREATE INDEX "ix_NodeType_source_identifier_types_source_identifier_types" ON "NodeType_source_identifier_types" (source_identifier_types);
...
CREATE TABLE "NodeType_additional_notes" (
	"NodeType_id" INTEGER,
	additional_notes TEXT,
	PRIMARY KEY ("NodeType_id", additional_notes),
	FOREIGN KEY("NodeType_id") REFERENCES "NodeType" (id)
);CREATE INDEX "ix_NodeType_additional_notes_additional_notes" ON "NodeType_additional_notes" (additional_notes);CREATE INDEX "ix_NodeType_additional_notes_NodeType_id" ON "NodeType_additional_notes" ("NodeType_id");
...
CREATE TABLE "SourceInformation_additional_notes" (
	"SourceInformation_id" INTEGER,
	additional_notes TEXT,
	PRIMARY KEY ("SourceInformation_id", additional_notes),
	FOREIGN KEY("SourceInformation_id") REFERENCES "SourceInformation" (id)
);CREATE INDEX "ix_SourceInformation_additional_notes_SourceInformation_id" ON "SourceInformation_additional_notes" ("SourceInformation_id");CREATE INDEX "ix_SourceInformation_additional_notes_additional_notes" ON "SourceInformation_additional_notes" (additional_notes);
