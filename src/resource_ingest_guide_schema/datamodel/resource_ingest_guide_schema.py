...
class SourceInformation(YAMLRoot):
    ...
    source_status: Optional[Union[str, "SourceStatusEnum"]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.source_status is not None and not isinstance(self.source_status, SourceStatusEnum):
            self.source_status = SourceStatusEnum(self.source_status)

        if not isinstance(self.additional_notes, list):
            self.additional_notes = [self.additional_notes] if self.additional_notes is not None else []
        self.additional_notes = [v if isinstance(v, str) else str(v) for v in self.additional_notes]
...
class SourceStatusEnum(EnumDefinitionImpl):
    """
    A term indicating the development status of a resource.
    """
    maintained_regular_updates = PermissibleValue(
        text="maintained_regular_updates",
        description="""the resource's data is being actively maintained and updated on a regular or recurring schedule""")
    maintained_as_needed_updates = PermissibleValue(
        text="maintained_as_needed_updates",
        description="""the resource's data is not being actively maintained and updated on a regular or recurring schedule""")
    not_maintained = PermissibleValue(
        text="not_maintained",
        description="the resource's data is not being actively maintained, and not subject to updates.")
    unknown = PermissibleValue(
        text="unknown",
        description="status of the source w.r.t. its maintenance and updates is not able to be determined.")
...
slots.sourceInformation__source_status = Slot(uri=BIOLINK.source_status, name="sourceInformation__source_status", curie=BIOLINK.curie('source_status'),
                   model_uri=BIOLINK.sourceInformation__source_status, domain=None, range=Optional[Union[str, "SourceStatusEnum"]])
...
slots.sourceInformation__additional_notes = Slot(uri=BIOLINK.additional_notes, name="sourceInformation__additional_notes", curie=BIOLINK.curie('additional_notes'),
                   model_uri=BIOLINK.sourceInformation__additional_notes, domain=None, range=Optional[Union[str, list[str]]])
...
slots.ingestInformation__additional_notes = Slot(uri=BIOLINK.additional_notes, name="ingestInformation__additional_notes", curie=BIOLINK.curie('additional_notes'),
                   model_uri=BIOLINK.ingestInformation__additional_notes, domain=None, range=Optional[Union[str, list[str]]])
...
slots.targetInformation__additional_notes = Slot(uri=BIOLINK.additional_notes, name="targetInformation__additional_notes", curie=BIOLINK.curie('additional_notes'),
                   model_uri=BIOLINK.targetInformation__additional_notes, domain=None, range=Optional[Union[str, list[str]]])
...
slots.edgeType__additional_notes = Slot(uri=BIOLINK.additional_notes, name="edgeType__additional_notes", curie=BIOLINK.curie('additional_notes'),
                   model_uri=BIOLINK.edgeType__additional_notes, domain=None, range=Optional[Union[str, list[str]]])
...
slots.nodeType__additional_notes = Slot(uri=BIOLINK.additional_notes, name="nodeType__additional_notes", curie=BIOLINK.curie('additional_notes'),
                   model_uri=BIOLINK.nodeType__additional_notes, domain=None, range=Optional[Union[str, list[str]]])
